...
func UpdateSelf(c *gin.Context) {
	...
	// 原有的用户信息更新逻辑
	if oldPassword, ok := requestData["old_password"]; ok {
		if _, hasOriginalPassword := requestData["original_password"]; !hasOriginalPassword {
			requestData["original_password"] = oldPassword
		}
	}
	var user model.User
